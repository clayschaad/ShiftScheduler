...
{
    [Fact]
    public void FindBestConnection_WithValidConnections_ShouldReturnLatestValidConnection()
    {
        // Arrange
        var connections = new List<TransportConnection>
        {
            new TransportConnection { ArrivalTime = "2023-12-15T07:15:00" },
            new TransportConnection { ArrivalTime = "2023-12-15T07:25:00" },
            new TransportConnection { ArrivalTime = "2023-12-15T07:35:00" } // This one is too late
        };
        var latestArrivalTime = new DateTime(2023, 12, 15, 7, 30, 0);

        // Act
        var result = TransportConnectionCalculator.FindBestConnection(connections, latestArrivalTime);
    ...
    [Fact]
    public void FindBestConnection_WithNoValidConnections_ShouldReturnEarliestConnection()
    {
        // Arrange
        var connections = new List<TransportConnection>
        {
            new TransportConnection { ArrivalTime = "2023-12-15T07:35:00" },
            new TransportConnection { ArrivalTime = "2023-12-15T07:40:00" },
            new TransportConnection { ArrivalTime = "2023-12-15T07:32:00" }
        };
        var latestArrivalTime = new DateTime(2023, 12, 15, 7, 30, 0);
        ...
        // Assert
        result.ShouldNotBeNull();
        result.ArrivalTime.ShouldBe("2023-12-15T07:32:00"); // Earliest of the invalid ones
    }

    [Fact]
    public void FindBestConnection_WithEmptyConnections_ShouldReturnNull()
    {
        // Arrange
        var connections = new List<TransportConnection>();
        var latestArrivalTime = new DateTime(2023, 12, 15, 7, 30, 0);
    ...
    [Fact]
    public void FindBestConnection_WithInvalidArrivalTimes_ShouldIgnoreInvalidEntries()
    {
        // Arrange
        var connections = new List<TransportConnection>
        {
            new TransportConnection { ArrivalTime = "invalid-time" },
            new TransportConnection { ArrivalTime = "2023-12-15T07:25:00" },
            new TransportConnection { ArrivalTime = "" }
        };
        var latestArrivalTime = new DateTime(2023, 12, 15, 7, 30, 0);
